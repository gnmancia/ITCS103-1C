...
label_result = Label(window, text="The sum is of 4 + 5 is 9.")
label_result.pack(pady=5)

frame = Frame(window, bg="gray")
frame.pack(fill="both", expand=True)

Label(frame, text="Enter 1st Number:", bg="white").grid(row=0, column=0, padx=5, pady=3)
num1 = Entry(frame, width=12)
num1.grid(row=0, column=1)

Label(frame, text="Enter 2nd Number:", bg="white").grid(row=1, column=0, padx=5, pady=3)
